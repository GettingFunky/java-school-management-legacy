            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input id="fathername" name="fathername" type="text"
                           ...
                           placeholder="Επώνυμο Πατρός" readonly>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input id="phoneNum" name="phoneNum" type="text"
                           ...
                           placeholder="Αριθμός Τηλεφώνου" readonly>
...
<div>
    ...
    <c:forEach items="${requestScope.cities}" var="city">
        <c:if test="${city.id == teacher.cityId}">
            <input type="text" value="${fn:escapeXml(city.name)}" readonly
