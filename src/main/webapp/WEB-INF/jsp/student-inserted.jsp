...
<c:set var="pageTitle" value="Επιτυχής Εισαγωγή" />
...
<main class="flex-grow container mx-auto px-4 py-12">
    <div class="max-w-xl mx-auto bg-white p-6 rounded-xl shadow-md border border-success-200">
        ...
        <p class="text-gray-700 text-lg mb-4">Ο μαθητής με κωδικό <strong>${sessionScope.studentInfo.id}</strong> καταχωρίστηκε επιτυχώς.</p>
        ...
        <div class="flex justify-end">
            <a href="${pageContext.request.contextPath}/school-app/students/view"
               class="inline-flex items-center px-4 py-2 bg-primary-500 hover:bg-primary-600 text-white font-medium rounded-lg transition">
                <i class="fas fa-arrow-left mr-2"></i> Επιστροφή στην προβολή μαθητών
            </a>
        </div>
    </div>
</main>
