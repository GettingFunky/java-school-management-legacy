...
<c:set var="pageTitle" value="Επιτυχής Ενημέρωση" />
...
<main class="flex-grow container mx-auto px-4 py-12">
    <div class="max-w-xl mx-auto bg-white p-6 rounded-xl shadow-md border border-success-200">
        <div class="flex items-center mb-4">
            ...
            <h1 class="text-2xl font-bold text-gray-800">Επιτυχής Ενημέρωση</h1>
        </div>
        <p class="text-gray-700 text-lg mb-4">Ο καθηγητής με κωδικό <strong>${sessionScope.teacherInfo.id}</strong> ενημερώθηκε επιτυχώς.</p>
