...
<c:set var="pageTitle" value="Προβολή Μαθητή" />
<%@ include file="header3.jsp" %>

<main class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Προβολή Μαθητή</h1>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input id="firstname" name="firstname" type="text" readonly
                           value="${fn:escapeXml(student.firstname)}"
                ...
                <div>
                    ...
                    <input id="lastname" name="lastname" type="text" readonly
                           value="${fn:escapeXml(student.lastname)}"
                           class="w-full px-3 py-2 border border-gray-300 bg-gray-100 text-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                           placeholder="Επώνυμο" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                  <div>
                                      ...
                                      <input id="birthDate" name="birthDate" type="date" readonly
                                             value="${fn:escapeXml(student.birthDate)}"
                                             class="w-full px-3 py-2 border border-gray-300 bg-gray-100 text-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input id="fathername" name="fathername" type="text" readonly
                           value="${fn:escapeXml(student.fatherName)}"
                           class="w-full px-3 py-2 border border-gray-300 bg-gray-100 text-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div>
                    ...
                    <input id="phoneNum" name="phoneNum" type="text" readonly
                           value="${fn:escapeXml(student.phoneNum)}"
                           class="w-full px-3 py-2 border border-gray-300 bg-gray-100 text-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input id="email" name="email" type="text" readonly
                           value="${fn:escapeXml(student.email)}"
                           class="w-full px-3 py-2 border border-gray-300 bg-gray-100 text-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                           placeholder="E-mail" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div>
                    ...
                    <input id="street" name="street" type="text" readonly
                           value="${fn:escapeXml(student.street)}"
                           class="w-full px-3 py-2 border border-gray-300 bg-gray-100 text-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                           placeholder="Οδός" />
                </div>
                <div>
                    ...
                    <input id="streetNum" name="streetNum" type="text" readonly
                           value="${fn:escapeXml(student.streetNum)}"
                           class="w-full px-3 py-2 border border-gray-300 bg-gray-100 text-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                           placeholder="Αριθμός" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div>
                    ...
                    <input id="zipcode" name="zipcode" type="text" readonly
                           value="${fn:escapeXml(student.zipCode)}"
                           class="w-full px-3 py-2 border border-gray-300 bg-gray-100 text-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                           placeholder="ΤΚ" />
                </div>
                <div>
