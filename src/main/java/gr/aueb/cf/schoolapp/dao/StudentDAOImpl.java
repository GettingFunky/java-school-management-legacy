...
public class StudentDAOImpl implements IStudentDAO {
    ...
    public Student insert(Student student) throws StudentDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            ps.setDate(10, Date.valueOf(student.getBirthDate()));
            ...
            //e.printStackTrace();
            // logging
            throw new StudentDAOException("SQL error in insert student with Lastname: " +
                    student.getLastname());
        }
    }
...
//            ps.setString(11, UUID.randomUUID().toString());
            ...
            e.printStackTrace();
            // logging
            throw new StudentDAOException("SQL error in update student with Lastname: " +
                    student.getLastname());
        }
    }
    ...
    public Student getStudentByEmail(String email) throws StudentDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            //e.printStackTrace();
            throw new StudentDAOException("SQL error in get with email: " + email);
        }
        return student;
    }
